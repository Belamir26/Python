...
def Iniciar():
    ...
    anim2 = animacion.FuncAnimation(fig2, plotData2,  fargs=(muestraD,lines),interval = 100, blit = False )
...
def plotData2(self,muestraD,lines):
    data.append(datos)
    lines.set_data(range(muestraD), data)
    labelx.set("VOL:" + str(datos)) 
...
lienzo2._tkcanvas.grid(row = 0,column = 0, padx = 1,pady = 1)
